...
_SAFE_OPERATIONAL_DOCS = frozenset(
    {
        ...
        "docs/security-hardening/p0a-production-control/context.md",
        "docs/security-hardening/p0a-production-control/diagrams/README.md",
        "docs/security-hardening/p0a-production-control/diagrams/production-control-and-artifact-binding-before.mmd",
        "docs/security-hardening/p0a-production-control/diagrams/production-control-and-artifact-binding-full-root-release-tree-after.mmd",
        "docs/security-hardening/p0a-production-control/diagrams/production-control-and-artifact-binding-privileged-release-agent-after.mmd",
        "docs/security-hardening/p0a-production-control/diagrams/production-control-and-artifact-binding-versioned-control-snapshot-after.mmd",
        "docs/security-hardening/p0a-production-control/hardening.json",
        "docs/security-hardening/p0a-production-control/hardening.md",
        "docs/security-hardening/p0a-production-control/implementation-plan.md",
        "docs/security-hardening/p0a-production-control/implementation/versioned-control-snapshot.md",
        "docs/security-hardening/p0a-production-control/proposals/production-control-and-artifact-binding.md",
...
_SAFE_NON_RUNTIME_GATES = frozenset(
    {
        ...
        ".gitignore",
        # 本地 git / Cursor 门禁；不进入镜像、服务配置或运行态。
        ".cursor/hooks.json",
        ...
        "deploy/scripts/release_store.py",
